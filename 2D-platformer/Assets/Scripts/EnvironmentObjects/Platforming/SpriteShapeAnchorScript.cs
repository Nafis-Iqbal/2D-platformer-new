...
public class SpriteShapeAnchorScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (splineAnchoredPointID > 0) initialSplineAnchoredLeftPosition = shapeSpline.GetPosition(splineAnchoredPointID - 1);
    ...
    void Update()
    {
        ...
        if (splineAnchoredPointID > 0) tempVectorLeft = initialSplineAnchoredLeftPosition;
        ...
        if (splineAnchoredPointID > 0) shapeSpline.SetPosition(splineAnchoredPointID - 1, tempVectorLeft);
