...
public class MovingPlatformScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // transform.position = Vector3.MoveTowards(transform.position, targetPointsCollection.transform.GetChild(destinationPlatformInd).transform.position,
    ...
    {
        if (other.gameObject.CompareTag("Player") && isMovementActive == false)
        {
