...
public class EnemyArcher : EnemyBase
{
    ...
    public void performArrowShot()
    {
        ...
        arrowObject.GetComponent<ArcProjectile>().initializeProjectile(projectileSpawnPosition[0].position, playerTransform.position, normalShotTopHeight, normalShotFlightTime, this.gameObject, characterFacingRight);
    ...
    {
        var arrowObject = ObjectPooler.Instance.SpawnFromPool("Arrow", projectileSpawnPosition[0].position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
        arrowObject.GetComponent<ArcProjectile>().initializeProjectile(projectileSpawnPosition[0].position, playerTransform.position, powerShotTopHeight, powerShotFlightTime, this.gameObject, characterFacingRight);
        arrowObject.SetActive(true);
    }
    ...
    {
        var arrowObject = ObjectPooler.Instance.SpawnFromPool("Arrow", projectileSpawnPosition[0].position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
        arrowObject.GetComponent<ArcProjectile>().initializeProjectile(projectileSpawnPosition[0].position, playerTransform.position, arcShotTopHeight, arcShotFlightTime, this.gameObject, characterFacingRight);
        arrowObject.SetActive(true);
    }
