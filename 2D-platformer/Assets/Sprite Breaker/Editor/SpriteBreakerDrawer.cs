...
public class SpriteBreakerDrawer : Editor
{
    ...
    private SerializedProperty
        ...
        createColliders,
        dataAsset,
        colliderThickness, massMultiplier, customGravityScale, fakeGravity,
    ...
    private void OnEnable()
    {
        ...
        customGravityScale = serializedObject.FindProperty("customGravityScale");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_showPhysics = EditorGUILayout.BeginFoldoutHeaderGroup(_showPhysics, labelPhysics))
        {
            ...
            if (createColliders.enumValueIndex != (int)SpriteBreaker.CreateColliders.None)
            {
                ...
                // gravity
                EditorGUILayout.PropertyField(customGravityScale);
